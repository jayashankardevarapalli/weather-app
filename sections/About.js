            ...
            <div className="flex flex-col sm:flex-row mt-10">
              <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                <div className="w-200 h-200 rounded-full inline-flex items-center justify-center">
                  <Image src={mrj} width="400" height="600" />
                </div>
              ...
              <div className="sm:w-2/3 sm:pl-8 sm:py-6 sm:border-l border-gray-200 sm:border-t-0 border-t mt-2 pt-12 align-center sm:mt-0 text-center sm:text-left">
